  ...
  return (
    <div>
      ...
      */}
      ...
      {/* 
      -resusable building blocks for the UI.
      - Components can be either class-based or functional.
      - They encapsulate logic, state, and rendering behavior.
      ...
      */}
      ...
      {/* 
        - State is a built-in object in React components that allows you to store and manage 
        dynamic data.
        -state is responsive to changes and triggers re-renders when updated.
        - Normal variables are not reactive and do not trigger re-renders when changed.
      */}
      <Counter />
      <h5>
      ...
      {/* 
        - In a class component, state is defined in the constructor using this.state.
        - State can be updated using this.setState().
      */}
      <CounterNew />
      <h5>Ques 9: How do you pass props to a functional component?</h5>
      {/* 
        - Props can be passed to a functional component by including them as attributes in the JSX tag.
        - Example: <MyComponent propName={value} />
      */}
...
// useState in react class component
// Ans 8 - Using state in class component
...
// components are defined like this first letter of the component name should be capitalized
// this can be called by <MyComponent /> in the JSX code
const MyComponent = () => {
  return (
    <ul>
...
const StatevsProps = (props) => {
  ...
  return (
    //  React.Fragment is used to group multiple elements without adding an extra node to the DOM same as <>
    <React.Fragment> 
